...
A 'repository' is really just a fancy name for a project on GitHub. It is a place online where you can manage projects, store files, and openly collaborate with others, using version control to track projects as they progress. As such, GitHub is a powerful tool for both software and non-software projects.
...
On your GitHub profile, click the 'Create new repository'. The first step is to create a name to brand your project with. Ideally, it should be memorable and give some indication of what the project does.
...
All four of these files should be kept in the root directory for your project repository. It is convention to use markdown file formats (.md) and capitalise all file names. Instead of spaces in file names, make sure to use underscores _ too. 
...
Thankfully, when you start a new repository on GitHub, you are given the option to select an existing license from a drop-down menu.
...
- [ ] Project has a LICENSE file based on an Open Source license
